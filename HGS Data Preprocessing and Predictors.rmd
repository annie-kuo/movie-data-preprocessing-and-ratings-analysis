...
```{r Task 1a part 1: Runtime Categories}
# FOR RUNTIME
...
**b.**
Yes, all three review site scores (IMDb, Rotten Tomatoes, Metacritic) seem to be some correlation with the Hidden Gem Scores.
...
**c.**
Yes, there is an upward trend over time in the Hidden Gem Scores by category of Runtime length.
